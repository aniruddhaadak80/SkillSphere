...
const Wellness = () => {
  ...
  { id: '14', category: 'Exercise', value: 30, target: 45, unit: 'minutes', icon: Flame, colorClass: 'bg-red-400' },
  { id: '15', category: 'Heart Health', value: 75, target: 80, unit: 'bpm', icon: Heart, colorClass: 'bg-teal-500' },
  { id: '16', category: 'Meditation', value: 20, target: 30, unit: 'minutes', icon: Smile, colorClass: 'bg-blue-600' },
  { id: '17', category: 'Productivity', value: 5, target: 8, unit: 'hours', icon: Coffee, colorClass: 'bg-yellow-600' },
  { id: '18', category: 'Music Listening', value: 60, target: 90, unit: 'minutes', icon: Music, colorClass: 'bg-indigo-700' },
  { id: '19', category: 'Energy Levels', value: 80, target: 100, unit: '%', icon: Zap, colorClass: 'bg-lime-600' },
  { id: '20', category: 'Outdoor Time', value: 40, target: 60, unit: 'minutes', icon: Leaf, colorClass: 'bg-green-600' },
  { id: '21', category: 'Self-Care', value: 50, target: 60, unit: 'minutes', icon: Star, colorClass: 'bg-purple-600' },
  ]);
