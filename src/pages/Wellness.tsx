...
const Wellness = () => {
  const [metrics] = useState<WellnessMetric[]>([
   { id: '1', category: 'Steps', value: 8432, target: 10000, unit: 'steps', icon: Activity, colorClass: 'bg-gradient-to-br from-blue-400 to-blue-600' },
  { id: '2', category: 'Sleep', value: 7.5, target: 8, unit: 'hours', icon: Moon, colorClass: 'bg-gradient-to-br from-indigo-400 to-indigo-600' },
  { id: '3', category: 'Mindfulness', value: 15, target: 20, unit: 'minutes', icon: Brain, colorClass: 'bg-gradient-to-br from-purple-400 to-purple-600' },
  { id: '4', category: 'Hydration', value: 2.3, target: 3, unit: 'liters', icon: Droplet, colorClass: 'bg-gradient-to-br from-teal-400 to-teal-600' },
  { id: '5', category: 'Sunlight', value: 40, target: 60, unit: 'minutes', icon: Sun, colorClass: 'bg-gradient-to-br from-yellow-400 to-yellow-600' },
  { id: '6', category: 'Calories Burned', value: 320, target: 500, unit: 'calories', icon: Flame, colorClass: 'bg-gradient-to-br from-orange-400 to-orange-600' },
  { id: '7', category: 'Air Quality', value: 90, target: 100, unit: 'AQI', icon: Cloud, colorClass: 'bg-gradient-to-br from-gray-400 to-gray-600' },
  { id: '8', category: 'Battery Health', value: 85, target: 100, unit: '%', icon: Battery, colorClass: 'bg-gradient-to-br from-green-400 to-green-600' },
  { id: '9', category: 'Weight Management', value: 72, target: 75, unit: 'kg', icon: Feather, colorClass: 'bg-gradient-to-br from-pink-400 to-pink-600' },
  { id: '10', category: 'Carbon Footprint', value: 2.5, target: 5, unit: 'tons', icon: Leaf, colorClass: 'bg-gradient-to-br from-lime-400 to-lime-600' },
  { id: '11', category: 'Wind Exposure', value: 12, target: 20, unit: 'minutes', icon: Wind, colorClass: 'bg-gradient-to-br from-cyan-400 to-cyan-600' },
  { id: '12', category: 'Mental Health', value: 80, target: 100, unit: '%', icon: Brain, colorClass: 'bg-gradient-to-br from-pink-500 to-pink-700' },
  { id: '13', category: 'Mood Tracking', value: 7, target: 10, unit: 'mood score', icon: Heart, colorClass: 'bg-gradient-to-br from-red-400 to-red-600' },
