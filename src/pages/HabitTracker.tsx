...
const HabitTracker = () => {
  ...
  const generateRandomColor = () => {
    const colors = [
      ...
      'bg-orange-200', 'bg-lime-200', 'bg-amber-200', 'bg-cyan-200',
      'bg-violet-200', 'bg-fuchsia-200', 'bg-rose-200', 'bg-sky-200',
      'bg-indigo-300', 'bg-orange-300', 'bg-pink-300', 'bg-yellow-300',
    ];
